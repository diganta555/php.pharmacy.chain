...
// echo $type;
$sql="SELECT SUM(customer_details.Total) as G_Total,pharmacy.Location from customer_details,pharmacy WHERE customer_details.Outlet=pharmacy.Pharmacy_Id and s_date between '$from' and '$to' GROUP BY pharmacy.Location";
...
<?php
    ...
    while($row = $result->fetch_assoc()) {
       ...
       echo "<tr>
       <td>".$row["Location"]."</td>
       <td>Rs ".$row["G_Total"]."</td></tr>";
       $GrandTotal +=$row['G_Total'];
     }
       echo "</table>";
   }else {
